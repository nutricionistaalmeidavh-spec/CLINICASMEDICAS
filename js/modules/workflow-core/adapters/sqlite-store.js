(function (root, factory) {
  ...
  function createSqliteWorkflowStore({ query, run } = {}) {
    ...
    function listPendingEvents(filters = {}) {
    ...
    function hasEffect(eventId, effectKey) {
    ...
    function markEffectApplied(eventId, effectKey, meta = {}) {
      if (hasEffect(eventId, effectKey)) return listEffects(eventId).find(item => item.effectKey === String(effectKey || '')) || null;
      ...
      return listEffects(eventId).find(item => item.effectKey === String(effectKey || '')) || null;
    }

    function listEffects(eventId) {
